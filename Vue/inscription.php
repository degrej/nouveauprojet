...
<html>
    ...
    <body>
        ...
        <form action="home.php" method="POST"> <!-- action permet de dire la page vers la quel on souhaite être redirigé. -->
			...
			<p>
				<label>Confirmer mot de passe <input type="password" name="confirm_password"/></label>
			</p>
			<p>
				<label>Acceptez-vous d'être contacté par notre site ? <input type="checkbox" name="contact"/></label>
			</p>
